...
if ($page == 1) {
                            ...
                            <div class="panel-body"> 
                                <form role="form"> 
                                    <div class"row ">
                                        ...
                                        <br>
                                        <label class="col-xs-6 col-md-offset-3" for="name">Subject</label>
 ...
 ';
    ...
    echo ' <!--tab-links-->
                ...
                <div class="tab-links">
                    <ul id="report_ul" class="nav nav-tabs">  
                    <li class="active"><a href="#sms_balance" data-toggle="tab">Check SMS Balance </a> </li>    
                    <li><a href="#sent_messages" data-toggle="tab">Sent SMS</a></li>    
                    <li> <a href="#message_template"  data-toggle="tab">Failed Delivery</a> </li>     
                    </ul>
                </div>
                <!--tab-links-->
 
                <!--tab-content-->
                <div id="sms_balance" class="tab-content">
                    <br> 
                    <div class="tab-pane fade in active" id="send_messages">                            
                        <div class="panel panel-default"> 
                            <div class="panel-heading"> <h3 class="panel-title">Check SMS Balance</h3>                                                
                             </div><!--panel-heading-->                               
                            <div class="panel-body"> 
                                <form role="form"> 
                                    <div class"row ">
                                        ...
                                        <div   class="form-group col-xs-6 col-md-offset-3""> 
                                            <label class="col-xs-6 col-md-offset-3" for="name">SMS Balance is<span class="label label-default">New</span> </label> 
                                        
                                            <br>
                                            <button id="request_sms_balance" type="submit" class="btn btn-primary ">Request Balance<span class="glyphicon glyphicon-send"></span> 
                                            </button>
                                         </div> 
                                    </div>
                                </form> 
                    ...
                    <div class="tab-pane fade" id="sent_messages"> 
                        <div class="panel panel-default">                                     
                            <div class="panel-heading"> <h3 class="panel-title">Send Message</h3>                                                
                             </div><!--panel-heading-->
 ...
 <div>No page specified
 
and data received is' . $page . '</div>
</div>
<div>'
